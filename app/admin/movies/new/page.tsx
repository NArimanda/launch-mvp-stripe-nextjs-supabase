  ...
  return (
    <div className="min-h-screen px-4 py-8 max-w-3xl mx-auto">
      <header className="mb-8">
        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">New movie</h1>
        <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
          Adds a row to the <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded">movies</code> table.
          Markets are not created automatically.
        </p>
      </header>
      <NewMovieForm />
    </div>
