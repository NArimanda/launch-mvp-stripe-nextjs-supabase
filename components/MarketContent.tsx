    ...
    <>
      ...
      <div className="mb-10 relative">
        <h2 className="text-xl font-semibold text-cinema-text mb-3">
          Place a Bet
          {isMarketClosed && <span className="text-orange-400 ml-2">(Market Closed)</span>}
          {isMarketResolved && <span className="text-red-400 ml-2">(Market Resolved)</span>}
        </h2>
        ...
        <div className="relative">
          ...
          {isMarketClosed && (
            <div className="absolute inset-0 bg-cinema-page/80 backdrop-blur-sm rounded-lg flex items-center justify-center z-10">
